    ...
    <body>
		...
		如果您想再次安装iCMS，请删除 ./include/install.lock 文件，再次运行安装文件</form></div></body></html>');
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="4">
                    ...
                    <tr>
                        <td colspan="2">数据表编码:UTF-8</td></tr>
                </table>
                <hr size="1" noshade="noshade" />
                <table width="100%" border="0" cellspacing="0" cellpadding="4">
                    <tr>
...
//		    	$DATABASESQL=$dbcharset=='gbk'?"DEFAULT CHARACTER SET gbk COLLATE gbk_chinese_ci":"DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci";
                            ...
                            iCMS_DB::query("INSERT INTO #iCMS@__admin VALUES('1','{$admin}','".md5($password)."','1','{$admin}','0','','N;','ADMINCP,header_index,menu_index_home,menu_index_forum_add,menu_index_article_add,menu_index_comment,menu_index_article_user_draft,menu_index_link,menu_index_advertise,header_setting,menu_setting_all,menu_setting_config,menu_setting_url,menu_setting_cache,menu_setting_attachments,menu_setting_watermark,menu_setting_publish,menu_setting_time,menu_setting_other,menu_setting_bbs,header_article,menu_forum_add,menu_forum_manage,menu_article_add,menu_article_manage,menu_article_draft,menu_article_trash,menu_article_user_manage,menu_article_user_draft,menu_comment,menu_contentype,menu_article_default,menu_filter,menu_tag_manage,menu_keywords,menu_search,menu_push_add,menu_push_forum,menu_push_manage,header_user,menu_user_manage,menu_account_manage,menu_account_edit,menu_group_manage,header_extend,menu_model_manage,menu_field_manage,menu_plugin_manage,menu_modifier_manage,header_html,menu_html_all,menu_html_index,menu_html_forum,menu_html_article,menu_html_tag,menu_html_page,menu_setting_url,header_tools,menu_link,menu_file_manage,menu_file_upload,menu_extract_pic,menu_advertise,menu_message,menu_cache,menu_template_manage,menu_database_backup,menu_database_recover,menu_database_repair,menu_database_replace,Allow_View_Article,Allow_Edit_Article','','','".time()."','0','0')");
